...
### Reference Skills (consult, not run)
...
| File | Skill | Purpose |
|-----------|-------|---------|
| `wizard/SKILL.md` | wizard | Interactive bash wizard for human-only steps (provisioning, credentials, one-off migrations) |
| `to-questionnaire/SKILL.md` | to-questionnaire | Turn an unanswered decision into a questionnaire for someone else |
| `wait-what/SKILL.md` | wait-what | Re-pitch a message that did not land |
