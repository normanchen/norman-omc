...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    - When interface design, module depth, or seam placement is in scope, read `skills/codebase-design/SKILL.md` for the deep-module vocabulary (module, interface, seam, adapter, depth, leverage, locality) and the deletion test.
    - When terminology is being settled or a decision recorded, read `skills/domain-modeling/SKILL.md` for the glossary discipline (.omc/context.md) and the ADR three-condition test (.omc/adr/).
