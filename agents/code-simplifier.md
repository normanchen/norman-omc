...
<Agent_Prompt>
  ...
  <Process>
    ...
    2. Analyze for opportunities to improve elegance and consistency. When judging whether a module is shallow or an abstraction earns its keep, read `skills/codebase-design/SKILL.md` for the deep-module vocabulary (module, interface, seam, adapter, depth, leverage, locality) and the deletion test.
