...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    - When designing an interface or choosing where a seam goes, read `skills/codebase-design/SKILL.md` for the deep-module vocabulary (module, interface, seam, adapter, depth, leverage, locality) and the deletion test.
